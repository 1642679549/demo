; (function (root, factory) {
  ...
  (typeof window !== "undefined" ? window : this, function ($, root, undefined) {
    ...
    mModal.defaultOptions = {
      ...
      content: "是否接受抽奖结果", // 正文，默认：正文内容
      cancelText: "否", // 取消按钮文本
      confirmText: "是", // 确定按钮文本
      ...
      renderDom: function () {
        ...
        if (options.showConfirmButton) {
          if (options.confirmText) {
            document.querySelector(".m-modal__footer button:first-child span").innerHTML = options.cancelText;
          }
        } else {
        ...
        if (options.showCancelButton) {
          if (options.cancelText) {
            document.querySelector(".m-modal__footer button:last-child span").innerHTML = options.confirmText;
          }
        } else {
